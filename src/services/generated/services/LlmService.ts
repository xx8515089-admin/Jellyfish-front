...
import type { ApiResponse_list_ModelDryRunPreviewRead__ } from '../models/ApiResponse_list_ModelDryRunPreviewRead__';
import type { ApiResponse_list_ProviderSupportedRead__ } from '../models/ApiResponse_list_ProviderSupportedRead__';
import type { ApiResponse_ModelDryRunPreviewRead_ } from '../models/ApiResponse_ModelDryRunPreviewRead_';
...
export class LlmService {
    ...
    /**
     * 预览供应商模型配置（不调用真实供应商）
     * @returns ApiResponse_list_ModelDryRunPreviewRead__ Successful Response
     * @throws ApiError
     */
    public static dryRunProviderModelsApiV1LlmProvidersProviderIdDryRunGet({
        providerId,
    }: {
        providerId: string,
    }): CancelablePromise<ApiResponse_list_ModelDryRunPreviewRead__> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/llm/providers/{provider_id}/dry-run',
            path: {
                'provider_id': providerId,
            },
            errors: {
    ...
    /**
     * 预览模型配置（不调用真实供应商）
     * @returns ApiResponse_ModelDryRunPreviewRead_ Successful Response
     * @throws ApiError
     */
    public static dryRunModelApiV1LlmModelsModelIdDryRunGet({
        modelId,
    }: {
        modelId: string,
    }): CancelablePromise<ApiResponse_ModelDryRunPreviewRead_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/llm/models/{model_id}/dry-run',
            path: {
                'model_id': modelId,
            },
            errors: {
