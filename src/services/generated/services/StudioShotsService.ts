...
import type { ApiResponse_ShotTableImportSummary_ } from '../models/ApiResponse_ShotTableImportSummary_';
...
import type { ShotTableImportRequest } from '../models/ShotTableImportRequest';
...
export class StudioShotsService {
    ...
    /**
     * 预览外部分镜表导入
     * @returns ApiResponse_ShotTableImportSummary_ Successful Response
     * @throws ApiError
     */
    public static previewShotTableImportApiApiV1StudioShotsImportTablePreviewPost({
        chapterId,
        requestBody,
    }: {
        /**
         ...
         */
        chapterId: string,
        requestBody: ShotTableImportRequest,
    }): CancelablePromise<ApiResponse_ShotTableImportSummary_> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/studio/shots/import-table/preview',
            query: {
                'chapter_id': chapterId,
            },
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static commitShotTableImportApiApiV1StudioShotsImportTableCommitPost({
        chapterId,
        requestBody,
    }: {
        /**
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/studio/shots/import-table/commit',
            query: {
                'chapter_id': chapterId,
            },
            body: requestBody,
